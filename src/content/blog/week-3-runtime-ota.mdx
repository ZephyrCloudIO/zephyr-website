...
<img
  src={Mariner6}
  alt="Mariner 6 and Mariner 7 missions to Mars"
  style={{ width: '100%', height: 'auto', display: 'block', margin: '2rem auto' }}
/>
...
There are more to come in the upcoming weeks. Hang out with us on [Discord](https://discord.gg/zephyrcloud) - we will keep you updated :)
