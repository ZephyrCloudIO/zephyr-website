...
- **Server Tokens**: Introduced **server authentication tokens** for secure automation and API access. Find out more [here](https://docs.zephyr-cloud.io/features/ci-cd-server-token)
