...
For Claude Code, install Zephyr Skills from the plugin marketplace:
...
For agents that support the `npx skills` CLI, install directly from GitHub:

```bash
npx skills add https://github.com/ZephyrCloudIO/skills
```

For Cursor, import the repository through **Settings > Rules > Project Rules > Add Rule > Remote Rule (GitHub)** and use this URL:

```text
https://github.com/ZephyrCloudIO/skills
```

You can also clone or copy the skill folders into your agent's skills directory:
