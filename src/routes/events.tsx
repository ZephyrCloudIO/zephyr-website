...
import { CalendarDays, MapPin, Clock, Users, Sparkles, Zap, Globe, FileText, Video, Presentation, Link as LinkIcon } from 'lucide-react'
    ...
    <div className={cn(
      ...
      <div className="relative z-10">
        <div className="flex items-start justify-between mb-4">
          <div className={cn("inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium", config.bg, config.border, config.text)}>
            <Icon size={14} />
            <span>{event.type.charAt(0).toUpperCase() + event.type.slice(1)}</span>
          </div>
          {event.isPast && (
            <span className="text-xs text-neutral-500 bg-neutral-800/50 px-2 py-1 rounded">Past</span>
          )}
        </div>
        ...
        <section className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-neutral-900 to-neutral-800 p-12 border border-neutral-700">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            <p className="text-neutral-300 mb-8 text-lg">
              Want to bring the power of runtime updates and Module Federation to your team?
              We offer custom workshops, speaking engagements, and acceleration weeks tailored to your needs.
            </p>
