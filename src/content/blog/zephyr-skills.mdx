...
<Tab label="npx skills" value="npx-skills">
...
Import the repository through **Settings > Rules > Project Rules > Add Rule > Remote Rule (GitHub)** and use this URL:
...
<Tab label="Manual copy" value="manual-copy">

Clone or copy the skill folders into your agent's skills directory:
