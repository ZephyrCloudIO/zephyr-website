...
export function NavigationMenuTrigger({ className, children, ...props }: NavigationMenuTriggerProps) {
  return (
    <RadixNavigationMenu.Trigger
      ...
      className={cn(
        'group inline-flex h-9 w-max items-center justify-center rounded-md px-4 py-2 font-medium text-sm hover:bg-main-foreground hover:text-primary',
    ...
    >
      ...
      <svg
        ...
        className="relative top-[1px] ml-1 size-3 group-data-[state=open]:rotate-180 motion-safe:transition motion-safe:duration-200"
        viewBox="0 0 24 24"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
