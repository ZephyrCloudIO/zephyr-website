...
const frameworkExamples: Partial<Record<FrameworkName, FrameworkDetails>> = {
  ...
  "React + Webpack + Module Federation": {
    ...
    exampleLink: 'https://github.com/ZephyrCloudIO/zephyr-examples/blob/main/examples/create-default-webpack-mf/app1/webpack.config.js',
    installCommand: [{ type: 'command' as const, content: 'install zephyr-webpack-plugin', lineNumber: 1 }]
  },
  "React + Vite": {
    lines: [3, 6],
    docsLink: 'https://docs.zephyr-cloud.io/recipes/react-vite',
    exampleLink: 'https://github.com/ZephyrCloudIO/zephyr-examples/blob/main/examples/react-vite-ts/vite.config.ts',
    installCommand: [{ type: 'command' as const, content: 'install vite-plugin-zephyr', lineNumber: 1 }]
  },
  "Qwik + Vite": {
    lines: [5, 18],
    docsLink: 'https://docs.zephyr-cloud.io/',
    exampleLink: 'https://github.com/ZephyrCloudIO/zephyr-examples/blob/main/examples/qwik-1.5/vite.config.ts',
    installCommand: [{ type: 'command' as const, content: 'install vite-plugin-zephyr', lineNumber: 1 }]
  }
};
...
const DeploymentSection: React.FC = () => {
  ...
  const deploymentOutput = [
    ...
    { type: 'output' as const, content: 'deploying....', label: 'ZEPHYR', labelColor: 'bg-[#FFFAC2] text-black' },
    { type: 'output' as const, content: 'uploading assets to edge....', label: 'ZEPHYR', labelColor: 'bg-[#FFFAC2] text-black' },
    { type: 'output' as const, content: 'application_id: team-green.Zephyr_Cloud_Id_Staging_Main_Zack_C', label: 'ZEPHYR', labelColor: 'bg-[#ACD7FF] text-black' },
    { type: 'output' as const, content: 'deployed to https://zephyr-cloud-io-staging-env.zehyr-cloud.com', label: 'ZEPHYR', labelColor: 'bg-[#ACD7FF] text-black' },
  ];
    ...
    <section className="py-24 bg-black border-2 rounded-lg border-[rgba(255,255,255,0.1)] bg-gradient-to-b from-[#2E335A]/10 from-10% via-[#1C1B33]/5 via-70% to-[#2E335A]/10 to-90%">
      <div className="container mx-auto px-4">
        ...
        className="space-y-4 max-w-4xl mx-auto opacity-0 animate-fade-in" style={{ '--animation-delay': '0ms' } as React.CSSProperties}>
          ...
          <CodeEditor framework={selectedFramework} highlightedLines={frameworkExamples[selectedFramework]?.lines} />
