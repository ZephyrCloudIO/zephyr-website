...
Today, we're announcing an amazing upcoming feature: **multi-CDN deployments in Zephyr Cloud** — giving you the ability to push the same build to **multiple cloud providers and domains** in a single, seamless flow. Whether it's Cloudflare, Fastly, Akamai — Zephyr, handles the propagation for you.
...
&emsp; _Fastly gets version v42._<br />
&emsp; _Cloudflare gets version v42._<br />
&emsp; _Akamai gets version v42._<br />
&emsp; _You get peace of mind._<br />
...
Selective deployment per version isn't the current model — we propagate to all active providers — but you can toggle **providers on or off** anytime. Want to stop deploying to a provider? One click. Future builds will skip it.
...
At Zephyr, our mission is to make the cloud feel more like a platform — and less like a _choose-your-own-infrastructure_ maze.
...
&emsp; _We want to be the universal versioned delivery layer for modern web applications._
