...
const PricingPage: React.FC = () => {
  const calculationCards = [
    {
      title: 'Usage',
      description: '1000 deployments per month and 5 federated remotes. More than enough to get you started.',
      link: '#',
      icon: (
    ...
    {
      title: 'Users',
      description: 'We believe that everyone should have visibility into their organization. So Zephyr Cloud has two user types: free (view only) and standard.',
      link: '#',
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      title: 'Your Price',
      description: 'Go from development to global scale on the edge in seconds. Make data driven decisions and control your application in ways not possible before.',
      link: '#',
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
