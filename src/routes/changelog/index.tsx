...
import { Calendar, Zap, Package, Shield, Rocket, Globe, Code } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-16 max-w-7xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-neutral-400">
            Latest updates and improvements to Zephyr Cloud
          </p>
        </div>
            ...
            <div key={`${group.year}-${group.month}`} className="mb-16">
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <div className="lg:hidden">
                  <div className="text-2xl font-bold text-white">{group.month} {group.year}</div>
                </div>
              </div>
