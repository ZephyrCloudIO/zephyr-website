  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
      ...
      <div className="prose prose-lg  prose-invert max-w-none">
        ...
        <br />
        <p>
          Our other online services we operate that post this Notice (&ldquo;Services&rdquo;). As a central part of our
          Services, we enable our customers and their employees (&ldquo;Customers&rdquo;) to track, observe and more
          effectively utilize software code and other developed components and content across their websites and online
          services. Through our Services, we may interact with our Customers&rsquo; online visitors to their websites
          and online services (&ldquo;Customers&rsquo; Audience&rdquo;).
        </p>
