...
export const pastEvents: Event[] = [
  ...
  },
  {
    ...
    type: 'conference',
    description:
      "A tech conference & expo unlike anything you've ever seen — a carnival of innovation, code & culture.",
  ...
  },
  {
    ...
    type: 'workshop',
    description:
      "A transformative week with Southern Glazer's Wine & Spirits, implementing sub-second deployments and revolutionizing their development workflow.",
    isPast: true,
    attendees: 40,
    resources: [
      {
  ...
  },
  {
    ...
    type: 'conference',
    description:
      'Commit is the event where we come together to explore our different ways developing and managing software. Join us for two days of sharing what we have to offer, and take the chance to break from your routine and try something new.',
    isPast: true,
    attendees: 2000,
    speakers: ['Nestor Lopez'],
