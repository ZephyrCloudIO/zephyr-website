...
const interviews = [
  {
    ...
    poster: '/videos/terry-fritsch.jpg',
    name: 'Terry Fritsch',
    role: 'VP of Digital Engineering, Southern Glazer’s · 18 min',
  },
  {
    src: '/videos/michael-mcmanus.mp4',
    poster: '/videos/michael-mcmanus.jpg',
    name: 'Michael McManus',
    role: 'Cloud, DevSecOps, and Engineering Enablement · 15 min',
  },
  {
    src: '/videos/matthew-carver.mp4',
    poster: '/videos/matthew-carver.jpg',
    name: 'Matthew Carver',
    role: 'Engineering Manager, Marketing Technology · 8 min',
  },
];
  ...
  return (
    <div className="pb-24">
      <figure className="bg-black">
        <video
          className="aspect-video mx-auto w-full max-h-[78vh] bg-black object-cover"
          controls
          playsInline
          preload="metadata"
        ...
        <figcaption className="mx-auto max-w-5xl px-4 pt-3 text-sm text-neutral-500 sm:px-6 lg:px-8">
          Southern Glazer’s Wine &amp; Spirits · Acceleration Week 2025 recap
        </figcaption>
      </figure>

      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <p className="mt-10 text-sm font-medium tracking-[0.18em] text-primary uppercase">Zephyr</p>
        ...
        <section className="mt-16 space-y-5 text-base leading-relaxed text-neutral-300">
          ...
          <p>
            ...
            is to take a direction that would otherwise take months and prove it, on the organization’s own cloud,
            before the company depends on it.
          </p>
          <p>
          ...
          <p>
            People often arrive unsure why they are there. The week still has a plan, and the room executes it. By
            Friday there is a working slice, a shared picture of the problem, and a clear line between what can start
            now and what waits on a cloud transition or a security review.
          </p>
        </section>
        ...
        <section className="mt-16">
          <div className="rounded-2xl border border-neutral-800 bg-neutral-950 p-6 sm:p-8">
            ...
            <div className="mt-8 space-y-5 border-t border-neutral-800 pt-8 text-base leading-relaxed text-neutral-300">
              ...
              <p>
                Their first week pulled a release path they had chased for six years into five days. Their second week,
                in 2025, pointed the same room at AI across how the organization works. The recap above is that second
                week.
              </p>
              <p>
                People at Southern Glazer’s often arrived unsure why they were in the room. The week still had a plan,
                and the room executed it. By the end, separate conversations had become one shared picture of the
                problem, and that picture went back to work with them.
              </p>
            </div>
          </div>
          ...
          <h2 className="mt-12 text-2xl font-semibold text-white">From the week</h2>
          <p className="mt-3 max-w-3xl text-neutral-400">
            Longer conversations from Southern Glazer’s Acceleration Week, filmed with the people in the room.
          </p>
          <div className="mt-6 grid gap-6 lg:grid-cols-1">
            {interviews.map((item) => (
              <figure key={item.src}>
                <video
                  className="aspect-video w-full rounded-xl border border-neutral-800 bg-neutral-950"
                  controls
                  playsInline
                  preload="metadata"
                  poster={item.poster}
