    ...
    <div className="items-center flex justify-center">
      ...
      >
        <h2
          ref={mainRef}
          className={cn(
            ' text-transparent relative z-30 w-auto bg-clip-text bg-gradient-to-br from-slate-500 via-slate-400/80 to-slate-200 text-base  tracking-wide duration-300 group:hover:text-gradient-bright group-hover:brightness-150  transform',
            {
