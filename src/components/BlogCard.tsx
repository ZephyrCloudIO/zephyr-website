  ...
  if (featured) {
    return (
      <Link to={`/blog/${post.slug}`} className="group block">
        <article className="bg-neutral-900/50 backdrop-blur-lg rounded-2xl overflow-hidden transition-all duration-300 hover:bg-neutral-800/50 hover:shadow-xl md:grid md:grid-cols-2">
          <div className="overflow-hidden md:aspect-auto aspect-video">
            <img
          ...
          <div className="p-8 flex flex-col justify-center">
            ...
            <h2 className="text-3xl font-bold mb-3 transition-colors group-hover:text-emerald-400 text-balance">
              {post.title}
            </h2>
            ...
            <p className="text-neutral-300 line-clamp-4 mb-6 text-pretty">{post.description}</p>
    ...
    <Link to={`/blog/${post.slug}`} className="group block">
      <article className="h-full bg-neutral-900/50 backdrop-blur-lg rounded-2xl overflow-hidden transition-all duration-300 hover:bg-neutral-800/50 hover:shadow-xl">
        ...
        <div className="p-6">
          ...
          <h3 className="text-xl font-semibold mb-2 transition-colors group-hover:text-emerald-400 text-balance">
            {post.title}
          </h3>
