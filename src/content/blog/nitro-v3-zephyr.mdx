...
[Nitro v3 beta](https://nitro.build/blog/v3-beta) landed on **March 11, 2026**. The headline for me is simple: Nitro backends can now ship straight to [Zephyr](https://zephyr-cloud.io).
