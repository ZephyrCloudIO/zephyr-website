...
![hero image](/static/image/ai-testing-hero.46aa11df.webp)
...
There is a readme in the [sample application](https://github.com/zackarychapple/bolt-mcmaster) that you can use to follow along to see the steps, mis-steps, and the reality
...
the prompt text are business decisions that we are yet to make.
