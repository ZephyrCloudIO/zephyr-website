...
import Devin from '../../../images/blog/devin.webp';

![hero image](/static/image/vibe-coding.b3952609.webp)
...
> Zephyr Cloud makes the dev loop so smooth that your favorite AI tools can jump right in–no set up needed. It’s not just about helping people move faster, it’s about gearing up the next-gen AI workforce too. - Alex Bennett: Accuris
...
> Absolute game-changer! Y’all are killing it and making devx for MFE feel like a breeze. This is how the future of frontend gets built & deployed. - Bill Watson: Navan
...
The clone is consists of 6 micro frontends, each responsible for a distinct feature or UI segment
* App Shell
* Feed
* Grok
* Create
...
After creating a directory quick I had claude go and generate a Nx workspace with some baseline tools I like to use like commitlint and husky.
...
There was two rather intense moments when using Devin:
...
* The synergy between developer creativity and AI suggestions speeds up the typical dev cycle especially when you can see their work in realtime.
